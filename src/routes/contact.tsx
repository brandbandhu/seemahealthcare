        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <Input id="n" required placeholder="Your full name" className="mt-1" />
            </div>
            <div>
              <Label htmlFor="m">Mobile</Label>
              <Input id="m" type="tel" required placeholder="10-digit mobile" className="mt-1" />
            </div>
            <div>
              <Label htmlFor="e">Email</Label>
              <Input id="e" type="email" placeholder="you@example.com" className="mt-1" />
            </div>
            <div>
              <Label htmlFor="o">Order number (optional)</Label>
              <Input id="o" placeholder="SH-ORD-..." className="mt-1" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <Textarea id="msg" rows={4} required placeholder="How can we help?" className="mt-1" />
          </div>
        ...
        <aside className="space-y-4">
          <div className="card-soft space-y-3 p-5 text-sm">
            <p className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-primary" /> {supportPhone}
            </p>
            <p className="flex items-center gap-2">
              <MessageCircle className="h-4 w-4 text-primary" /> WhatsApp {supportWhatsApp}
            </p>
            <p className="flex items-center gap-2">
              <Mail className="h-4 w-4 text-primary" /> {supportEmail}
            </p>
            <p className="flex items-start gap-2">
              <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-primary" /> Seema Healthcare, Ring Road, Nagpur, Maharashtra 440015
            </p>
            <p className="flex items-center gap-2">
              <Clock className="h-4 w-4 text-primary" /> 9:00 am - 9:00 pm, all days
            </p>
          </div>
